"""
Django settings for hngxtwo project.
...
WSGI_APPLICATION = 'hngxtwo.wsgi.application'
...
# the base URL for serving static files in your application.
STATIC_URL = '/static/'

#  the directory where collected static files should be placed
